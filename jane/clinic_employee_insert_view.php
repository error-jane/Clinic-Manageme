            ...
            <div class="card wizard-card" data-color="blue" >
                ...
                <div class = "col-11">      
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            <select class="custom-select "  name="select_role" id="select_role" value = "" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            ...
                            pattern="[a-zA-Zก-ํ.]{1,}"
                            placeholder="First Name" autocomplete="off" value=""  required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-4">
                            ...
                            pattern="[a-zA-Zก-ํ]{1,}"
                            placeholder="Last Name" autocomplete="off" value=""  required>
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4">
                            ...
                            pattern="[0-9]{10}$"
                            maxlength ="10" placeholder = "Phone number" autocomplete="off" value = ""  required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-4">
                            <div class="form-check">
                                ...
                                name="select_gender" id="gender_1" value="01" required>
                                <label class="form-check-label " for="gender_1">Male</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input col-sm-2" type="radio"
                                name="select_gender" id="gender_2" value="02" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <textarea class="form-control" name="textarea_address" id="textarea_address" rows="5" cols="40" required><?php echo $address;?></textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            <input type="number" class="form-control" name="input_salary" id="input_salary"
                            placeholder = "Salary"
                    ...
                    <div class="d-flex flex-row-reverse">
                        <div>
                            <button  type="submit" name="submit" id="btn_submit" value="1" class="btn btn-primary btn-block">
                                Add New Employee
                            </button>
                        </div>
                    </div>
